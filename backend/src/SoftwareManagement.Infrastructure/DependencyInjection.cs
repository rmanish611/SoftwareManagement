...
using SoftwareManagement.Infrastructure.Portfolio;
...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddSingleton<ISystemSettings, SystemSettingsCache>();
        ...
        services.AddScoped<IOutboxPump, OutboxPump>();
        services.AddHostedService<OutboxPumpService>();
