        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DisplayTimeZone = table.Column<string>(type: "nvarchar(60)", maxLength: 60, nullable: false),
                    LastLoginAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    NotifyOnNewLead = table.Column<bool>(type: "bit", nullable: false),
                    NotifyDailyDigest = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoginAttempts_EmailAttempted_CreatedAtUtc",
                table: "LoginAttempts",
                columns: new[] { "EmailAttempted", "CreatedAtUtc" });
